export default function Home() {
    ...
    return (
      ...
      <div className="flex flex-col px-5">
        ...
        <button className="justify-center self-end px-9 py-5 mt-12 text-sm font-bold leading-5 text-white whitespace-nowrap bg-teal-400 rounded-lg border-white border-solid border-[3px] max-md:px-5 max-md:mt-10">
          Save Changes
        </button>
      </div>
      </div>
